        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-4 text-stone-600 text-lg leading-relaxed">
              <p>
                Willkommen im Tischleratelier Sinnesmagnet. Mein Name ist Thomas Müller (Beispielname), und Holz ist meine Leidenschaft. In meiner Werkstatt im Herzen von Dresden entstehen Möbel, die mehr sind als nur Gebrauchsgegenstände.
              </p>
              <p>
